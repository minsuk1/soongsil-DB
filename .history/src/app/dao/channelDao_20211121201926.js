...
async function expected() {
  ...
  const Query = 
                    `
                    SELECT V.Title, U.UserName, V.TotalView, V.Descriptions, TIMESTAMPDIFF(DD, V.FirstCreated, GETDATE()) AS '일차이'
...
module.exports = {
  expected,watch_later,like_videos,subscription,totalwatchingview
};